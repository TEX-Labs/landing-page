  ...
  return (
    <>
      <div className="py-[-10px] flex flex-col lg:flex-row items-center justify-center bg-black/[0.96] antialiased bg-grid-white/[0.04] w-full gap-4 mx-auto px-8">
        <Card
          title="Real-time token price and on-chain data with Socket"
        ...
        <Card
          title="AI-Enhanced Telegram Bots for Trading, Alerts & Tracking"
          description="Telegram Bot Solutions"
          icon={<Borrow />}
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          title="AI-Blockchain Integration: Smart Contract Analysis & Meeting Summaries"
